...
INSERT INTO `items` (`name`, `label`, `limit`, `rare`, `can_remove`) VALUES ('stingray', 'Stingray', 5, 0, 1);
INSERT INTO `items` (`name`, `label`, `limit`, `rare`, `can_remove`) VALUES ('dolphin', 'Dolphin', 3, 0, 1);
INSERT INTO `items` (`name`, `label`, `limit`, `rare`, `can_remove`) VALUES ('sharktiger', 'Tiger Shark', 3, 0, 1);
INSERT INTO `items` (`name`, `label`, `limit`, `rare`, `can_remove`) VALUES ('sharkhammer', 'Hammerhead Shark', 3, 0, 1);
INSERT INTO `items` (`name`, `label`, `limit`, `rare`, `can_remove`) VALUES ('killerwhale', 'Killer Whale', 2, 0, 1);
